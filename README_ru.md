...
а затем - эту:␣␣
`gradle build`.␣␣
**Внимание:** для компиляции данной программы вам потребуется установленный в системе Gradle, а так же JDK Java 21 (либо любой другой поддерживаемой версии, но в таком случае вам прийдётся отредактировать файл build.gradle).␣␣
